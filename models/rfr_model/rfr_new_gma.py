...
from models.rfr_common.update import GMAUpdateBlock
...
class RFR_gma(nn.Module):
    def __init__(self, args):
        super(RFR_gma, self).__init__()
        self.args = args
        ...
        self.args.requires_sq_flow=True
    ...
    def forward_pred(self, image1, image2, iters=12, flow_init=None, upsample=True, test_mode=False):
        ...
        for itr in range(iters):
            ...
            with autocast(enabled=self.args.mixed_precision):
                net, up_mask, delta_flow = self.update_block(net, inp, corr, flow, attention) #GRU part 
